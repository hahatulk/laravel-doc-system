...
import {REACT_APP_ADMIN_USER_CREDENTIALS, REACT_APP_ADMIN_USER_EDIT_CREDENTIALS} from "../../Routes";
...
function ModalUserData(props: any) {
    ...
    function handleSubmit(username: any, password: any, status: any) {
        setLoading(true)
        axios.post(REACT_APP_ADMIN_USER_EDIT_CREDENTIALS + ``,
            {
    ...
    useEffect(() => {
        if (open) {
            ...
            axios.get(REACT_APP_ADMIN_USER_CREDENTIALS,{
                params:{
                    userId: props.userId
                }
            })
