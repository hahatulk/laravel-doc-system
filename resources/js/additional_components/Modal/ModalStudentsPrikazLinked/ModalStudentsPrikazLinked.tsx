...
import {REACT_APP_ADMIN_STUDENTS_LINKED_TO_PRIKAZ} from "../../Routes";
                                ...
                                props.groupId !== undefined
                                    ? <>
                                        ...
                                        <Button color={'primary'}
                                                ...
                                                onClick={() => {
                                                    props.exportStudents(currentHiddenColumnNames, filters, -1)
                                                }}
                                        >
                                            Экспорт
                                        </Button>
                                        ...
                                        <Button color={'primary'}
                                                ...
                                                style={{marginRight: '25px'}}
                                                onClick={() => {
                                                    props.exportStudentsWithCredentials(currentHiddenColumnNames, filters, -1)
                                                }}
                                        >
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(ModalStudentsPrikazLinked))
