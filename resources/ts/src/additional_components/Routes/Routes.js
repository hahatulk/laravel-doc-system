...
export const
    ...
    REACT_APP_ORDER_CANCEL=`${H_DOMAIN}/api/order/cancel`,
    REACT_APP_ORDER_CREATE_SPRAVKA_OB_OBUCHENII=`${H_DOMAIN}/api/order/create/spravka_ob_obuchenii`,
    ...
    REACT_APP_ADMIN_STUDENT_EDIT_GETALL_GROUPS_ACTIVE=`${H_DOMAIN}/api/student/getall_groups_active`,
    REACT_APP_ADMIN_STUDENT_EDIT_GETALL_GROUPS=`${H_DOMAIN}/api/student/getall_groups`,
    REACT_APP_ADMIN_STUDENT_CREDENTIALS=`${H_DOMAIN}/api/student/credentials`,
    REACT_APP_ADMIN_STUDENT_EDIT_CREDENTIALS=`${H_DOMAIN}/api/student/credentials/edit`,
    REACT_APP_ADMIN_STUDENTS_LINKED_TO_PRIKAZ=`${H_DOMAIN}/api/students/prikaz_linked`,
    REACT_APP_ADMIN_EXPORT_DATA_WITH_CREDENTIALS=`${H_DOMAIN}/api/student/export_with_credentials`,
    REACT_APP_ADMIN_FACULTETS_GET=`${H_DOMAIN}/api/student/getAll_facultets`,
    REACT_APP_ADMIN_EXPORT_DATA=`${H_DOMAIN}/api/student/export`,
    REACT_APP_ADMIN_ORDERS_LIST=`${H_DOMAIN}/api/orders/list`,
    REACT_APP_ADMIN_ORDERS_LIST_ARCHIVED=`${H_DOMAIN}/api/orders/list_archived`,
    ...
    REACT_APP_ADMIN_GROUPS_LIST_GET=`${H_DOMAIN}/api/groups/list`,
    REACT_APP_ADMIN_GROUPS_EDIT=`${H_DOMAIN}/api/groups/edit`,
    REACT_APP_ADMIN_GROUPS_DELETE=`${H_DOMAIN}/api/groups/delete`,
    REACT_APP_ADMIN_GROUPS_CREATE=`${H_DOMAIN}/api/groups/create`,
    REACT_APP_ADMIN_PRIKAZ_ZACHISLENIE=`${H_DOMAIN}/api/create/prikaz/zachislenie`,
