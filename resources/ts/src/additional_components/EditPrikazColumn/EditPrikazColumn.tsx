...
import {REACT_APP_ADMIN_PRIKAZ_TYPES} from "../Routes/Routes";
                        ...
                        <FormGroup>
                            <FormControl margin={'normal'} style={{width: '100%'}}>
                                ...
                                <Select
                                    ...
                                    name={'name'}
                                    value={row.name}
                                    disabled={prikazTypesLoading || !prikazTypes?.length || row.name === 'приказ_о_зачислении'}
                                    onChange={onChange}
                                >
                                    {
                                        !prikazTypesLoading
