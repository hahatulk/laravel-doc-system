...
import {ordersGetToRedux} from "./actionsLk";
import fileDownload from "js-file-download";
import {getLocalPlainDateTime} from "../../additional_components/Dates";
import {
    REACT_APP_ADMIN_ARCHIVED_STUDENTS_LIST_GET, REACT_APP_ADMIN_DOWNLOAD_EXCEL_DOCUMENT_BY_PATH, REACT_APP_ADMIN_EXPORT_DATA,
    REACT_APP_ADMIN_EXPORT_DATA_WITH_CREDENTIALS, REACT_APP_ADMIN_GROUPS_DELETE, REACT_APP_ADMIN_GROUPS_EDIT,
    REACT_APP_ADMIN_GROUPS_LIST_GET, REACT_APP_ADMIN_IMPORT_STUDENTS_TEMPLATE_PATH, REACT_APP_ADMIN_MODERATORS_DELETE,
    REACT_APP_ADMIN_MODERATORS_GET, REACT_APP_ADMIN_PRIKAZ_DELETE, REACT_APP_ADMIN_PRIKAZ_EDIT,
    REACT_APP_ADMIN_PRIKAZ_LIST, REACT_APP_ADMIN_STUDENT_EDIT,
    REACT_APP_ADMIN_STUDENTS_LIST_GET, REACT_APP_ORDERS
} from "../../additional_components/Routes/Routes";
...
export function getGroupsList(
    ...
    return async (dispatch: any) => {
        ...
        return await axios.post(REACT_APP_ADMIN_GROUPS_LIST_GET + ``,
            {
                offset: offset,
                limit: limit,
                page: page,
...
export function getPrikazList(
    ...
    return async (dispatch: any) => {
        ...
        return await axios.post(REACT_APP_ADMIN_PRIKAZ_LIST + ``,
            {
                offset: offset,
                limit: limit,
                page: page,
...
export function getStudentsList(
    ...
    return async (dispatch: any) => {
        ...
        return await axios.get(REACT_APP_ADMIN_STUDENTS_LIST_GET +
            `?page=${Number(page) + 1}` + (sort?.length ? `&sort=${JSON.stringify(sort[0])}` : ``) + (filters?.length ? `&filters=${JSON.stringify(filters)}` : ``),
...
export function getArchivedStudentsList(
    ...
    return async (dispatch: any) => {
        ...
        return await axios.post(REACT_APP_ADMIN_ARCHIVED_STUDENTS_LIST_GET + ``,
            {
                offset: offset,
                limit: limit,
                page: page,
...
export function deletePrikaz(
    ...
    return async (dispatch: any) => {
        return await axios.post(REACT_APP_ADMIN_PRIKAZ_DELETE + ``,
            {
                prikazId: prikazId,
            }
        )
...
export function deleteGroup(
    ...
    return async (dispatch: any) => {
        return await axios.post(REACT_APP_ADMIN_GROUPS_DELETE + ``,
            {
                groupId: groupId,
            }
        )
...
export function ordersGet(limit: number, offset: number, cb?: Function | undefined): any {
    return async (dispatch: any) => {
...
export function exportStudents(restrictedColumns: any[], filters: any[], type?: string | undefined): any {
    return async (dispatch: any) => {
        return await axios.post(REACT_APP_ADMIN_EXPORT_DATA + ``,
            {
...
export function exportStudentsWithCredentials(restrictedColumns: any[], filters: any[], type?: string | undefined): any {
    return async (dispatch: any) => {
